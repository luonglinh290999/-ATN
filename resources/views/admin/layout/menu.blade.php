<!-- Main sidebar -->
			<div class="sidebar sidebar-main" style="font-family: cursive; background-color: #404040">
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- Main -->
								<li class="navigation-header"><span>TRANG QUẢN TRỊ</span> <i class="icon-menu" title="Main pages"></i></li>
