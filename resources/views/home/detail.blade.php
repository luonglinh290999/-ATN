...
<div class="container" style="font-family: cursive;">
	<div class="row">
		<div class="col-md-12" style="margin-top: 60px">
			<ul class="breadcrumb">
				<li><a href="#" style="color: #8B0000">Trang Chủ</a></li>
				<li><a href="#" style="color: #8B0000">{{ $motelroom->category->name }}</a></li>
				<li class="active" style="color: #FA8072">{{ $motelroom->title }}</li>
			</ul>
		</div>
	</div>
</div>
<div class="container" style="font-family: cursive;">
	<div class="row">
		<div class="col-md-8">
			...
			<div class="detail">
				...
				<pre style="font-weight: normal; word-break: break-word;">
					<p style="font-family: cursive;">{{ $motelroom->description }}</p>
				</pre>
			</div>
		...
		<div class="col-md-4">
			...
			<div class="phone_btn">
				<a id="show_phone_bnt" href="callto:{{ $motelroom->phone }}" class="btn btn-primary btn-block" style="font-weight: bold !important; font-size: 14px; background-color: #FA8072; border: none">
			...
			<div class="detail" style="margin-top: 30px;">
				...
				<div id="km-detail" style="margin-top: 30px; border-color: #FA8072">
					<div class="fs-dtslt" style="background-color: #FA8072; border: none">Tiện ích Phòng Trọ</div>
					<div style="padding: 5px;">
						@foreach($arrtienich as $tienich)
						<span><i class="fas fa-check" style="color: #FA8072"></i> {{ $tienich }}</span>
						@endforeach
					</div>
				</div>
			</div>
			<div class="report" style="margin-top: 30px;">
				...
				<form action="{{ route('user.report',['id'=> $motelroom->id]) }}">
					...
					<button class="btn btn-danger" style="background-color: #FA8072; border: none">Gửi báo cáo</button>
				</form>
			</div>
			@endif
			@if(!empty(Auth::user()) && ($motelroom->user->id == Auth::user()->id || Auth::user()->right == 1))
			<div style="width:100%; margin-top:10px; text-align:center">
				<a class="btn btn-success" href="user/edit-post/{{ $motelroom->slug }}" style="background-color: #FA8072; border: none">Sửa bài đăng</a>
			</div>
			@endif
		</div>
	</div>
