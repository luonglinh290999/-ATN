...
<div class="container" style="padding-left: 0px;padding-right: 0px; font-family: cursive;">
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2" style="margin-bottom: 50px">
			<div class="gap"></div>
			<div class="panel panel-primary" style="color: #B22222; border-color: pink">
				<div class="panel-heading" style="background-color: #FA8072; color: #B22222; border-color: pink">Chỉnh sửa hồ sơ</div>
					...
					<form class="form-horizontal" method="POST" action="{{ route('user.edit') }}" enctype="multipart/form-data">
						...
						<div class="content-upload">
							<center>
								...
								@endif
								<label for="avtuser" class="labelforfile" style="background-color: #FA8072; color: #B22222"><i class="fas fa-file-image"></i> Chọn ảnh</label>
						...
						<div class="form-group"> 
							<div class="col-sm-offset-5 col-sm-9">
								<button type="submit" class="btn btn-primary" style="background-color: #FA8072; color: #B22222; border: none">Chỉnh sửa</button>
							</div>
						</div>
