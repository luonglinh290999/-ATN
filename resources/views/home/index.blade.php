...
<div class="">
	...
	<div>
		<img class="mySlides" width="100%" src="../images/phongtro2.jpg">
		<img class="mySlides" width="100%" src="../images/phong1.jpg">
		<img class="mySlides" width="100%" src="../images/phong3.png">
	</div>
	</div>
		<div class="box-search" style="font-family: cursive;">
			<form onsubmit="return false">
				...
				<div class="form-group row">
					...
					<div class="col-xs-3">
						<button class="btn btn-success" onclick="searchMotelajax()" style="background-color: #FA8072; border: none">Tìm kiếm ngay</button>
					</div>
				</div>
				</form>
		</div>
	...
	<div class="container" style="padding-top: 30px; font-family: cursive;">
		<div><h3 class="title-comm"><span class="title-holder">PHÒNG TRỌ XEM NHIỀU NHẤT</span></h3></div>
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="room-detail">
							<h4><a href="phongtro/{{ $room->slug }}" style="color: #FF6347">{{ $room->title }}</a></h4>
							<div class="room-meta">
