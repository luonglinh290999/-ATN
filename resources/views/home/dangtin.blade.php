...
<div class="container">
	<div class="row">
		<div class="col-md-8" style="color: #B22222; font-family: cursive;">
			<h1 style="margin-top: 100px; margin:center">ĐĂNG TIN PHÒNG TRỌ</h1>
			<hr>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="txtphone" class="form-control" placeholder="03922801228">
                </div>
              </div>
            </div> 
            <div class="form-group">
              ...
              <select id="select-state" name="tienich[]" multiple class="demo-default" placeholder="Chọn các tiện ích phòng trọ">
                ...
                <option value="Có nóng lạnh">Có nóng lạnh</option>
              </select>
            </div>
            <div class="form-group">
