		...
		<div class="col-12">
			<div class="banner-info mb-5">
				<div class="mapInfo false" style="" data-reactid="47">
					...
					<img style="color:#ffffff;background-color:rgb(188, 188, 188);user-select:none;display:inline-flex;align-items:center;justify-content:center;font-size:40px;border-radius:50%;height:80px;width:80px;" alt="Thùy Linh" size="80" src="images/no-avatar.jpg" class="avatar" data-reactid="57">
					@else
					<img style="color:#ffffff;background-color:rgb(188, 188, 188);user-select:none;display:inline-flex;align-items:center;justify-content:center;font-size:40px;border-radius:50%;height:250px;width:250px;" alt="Thùy Linh" size="80" src="uploads/avatars/{{Auth::user()->avatar}}" class="avatar" data-reactid="57">
					@endif
				...
				<div class="info" style="font-family: cursive;">
			...
			<div class="mypage" style="font-family: cursive;">
				...
				<div class="mainpage">
					@if( count($mypost) < 1)
					<div class="alert alert-info" style="color: #B22222; background-color: #FF6347; ; border-color: #B22222">
						Bạn chưa có tin đăng phòng trọ nào đang cho thuê, thử đăng ngay.
					</div>
					<a href="user/dangtin" class="btn-post" style="color: #B22222; border-color: #B22222">ĐĂNG TIN</a>
					@else
