		...
		success : function (result){
			...
			if(result_room.length != 0) {
				...
				for (i in result_room){
					...
					title = '<div style="font-family: cursive;"><h3 class="title-comm"><span class="title-holder">KẾT QUẢ TÌM KIẾM</span></h3></div>'
					content += '<div class="col-md-4 col-sm-6" style="font-family: cursive;">\n\
					<div class="room-item">\n\
					...
					<div class="room-detail">\n\
						<h4><a href="phongtro/'+data.slug+'" style="color: #FF6347">'+data.title+'</a></h4>\n\
						<div class="room-meta">\n\
							<span><i class="fas fa-user-circle"></i> Người đăng:'+data.user.name+'</span>\n\
				...
				$("#title1").html(title);
				document.getElementById("title1").setAttribute("class", "fix");
				$("#room-hot").html(content);
				document.getElementById("room-hot").setAttribute("class", "demo");
			}
			else {
