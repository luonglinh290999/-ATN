...
Route::get('/', function () {
    ...
    $listmotelroom = Motelroom::where('approve',1)->orderBy('id','desc')->paginate(4);
...
Route::group(['prefix'=>'user'], function () {
    ...
    Route::get('edit-post/{slug}','UserController@get_suatin')->middleware('dangtinmiddleware');
    Route::post('edit-post/{slug}','usercontroller@post_suatin')->name('user.edit-post')->middleware('dangtinmiddleware');
...
Route::get('quen_mat_khau','UserController@quen_mat_khau');
Route::post('recover-pass','UserController@recover_pass');
Route::get('update-new-pass','UserController@update_new_pass');
Route::post('reset-new-pass','UserController@reset_new_pass');
